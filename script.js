...
async function main() {
  ...
  currentSong.addEventListener("timeupdate", () => {
    ...
    )}/${formatSecondsToMinutes(currentSong.duration)}`;
  ...
  //login form
   function showForm(formType) {
            ...
            if(formType === 'signup') {
                document.querySelector('.signupbtn').style.backgroundColor = '#45a049';
                document.querySelector('.loginbtn').style.backgroundColor = '#4285f4';
            } else {
                document.querySelector('.signupbtn').style.backgroundColor = '#4CAF50';
                document.querySelector('.loginbtn').style.backgroundColor = '#357ae8';
            }
        }
}
